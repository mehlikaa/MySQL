...
==============================================================================*/  
   ...
   CREATE TABLE tedarikciler
    ...
    SELECT * FROM tedarikciler,urunler;
    SELECT * FROM urunler;
...
/* -----------------------------------------------------------------------------
 ...
 -----------------------------------------------------------------------------*/ 
    update urunler set urun_id=urun_id+1 where urun_id>1004;  -- sectim simdi set et
     select * from urunler;
...
/*-----------------------------------------------------------------------------
 ...
 degistiriniz.
 -----------------------------------------------------------------------------*/
select * from urunler;                    select * from tedarikciler;

delete from tedarikciler;           -- yapilan degisiklikler icin silip yeni insert yaptik.

  update urunler set urun_isim=(select firma_isim  from tedarikciler where irtibat_ismi='Adam Eve')
