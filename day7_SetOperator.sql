...
union 				-- tekrarlilari iptal eder, union all denirse ayni olsa da hepsini yazdirir. 	
select maas, sehir
from personel
...
select isim, maas, sirket
from personel
where sirket!='Honda'; 		-- esit degildir yerine <> kullanilablir 
...
-- sirket lerden grupla sirketlerin calisan isimlerini say
